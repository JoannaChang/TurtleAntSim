...
public class ArenaArray {
	...
	public static void main(String[] s) {
		...
		//specify rows, columns, sizes of boxes, and whether it's a custom arena
		...
		a.addBoxBridge(3, 2, 3, 3, 'H', 10); // additional-cavity only


		// additional-cavity R nests
		a.addBoxNest(0, 2, "R1");
		a.addBoxNest(0, 3, "R2");
		a.addBoxNest(1, 2, "R3");
		a.addBoxNest(1, 3, "R4");

		// additional-cavity D nests
		a.addBoxNest(2, 0, "D1");
		a.addBoxNest(3, 1, "D2");
		a.addBoxNest(2, 2, "D3");
		a.addBoxNest(3, 3, "D4");

		// // limited-cavity R nests
		// a.addBoxNest(0, 3, "R1");
		// a.addBoxNest(1, 2, "R2");
		// a.addBoxNest(1, 3, "R3");

		// // limited-cavity D nests
		// a.addBoxNest(3, 0, "D1");
		// a.addBoxNest(2, 1, "D2");
		// a.addBoxNest(3, 2, "D3");
